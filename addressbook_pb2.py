...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='tutorial',
  syntax='proto2',
  serialized_pb=_b('\n\x11\x61\x64\x64ressbook.proto\x12\x08tutorial\"\x90\x03\n\x06Person\x12\x0c\n\x04name\x18\x01 \x02(\t\x12\n\n\x02id\x18\x02 \x02(\x05\x12\r\n\x05\x65mail\x18\x03 \x01(\t\x12,\n\x06phones\x18\x04 \x03(\x0b\x32\x1c.tutorial.Person.PhoneNumber\x12+\n\taddresses\x18\x05 \x03(\x0b\x32\x18.tutorial.Person.Address\x1aM\n\x0bPhoneNumber\x12\x0e\n\x06number\x18\x01 \x02(\t\x12.\n\x04type\x18\x02 \x01(\x0e\x32\x1a.tutorial.Person.PhoneType:\x04HOME\x1a_\n\x07\x41\x64\x64ress\x12\x0e\n\x06street\x18\x01 \x01(\t\x12\x0e\n\x06number\x18\x02 \x01(\t\x12\x34\n\x04type\x18\x03 \x01(\x0e\x32\x1d.tutorial.Person.BuildingType:\x07private\"+\n\tPhoneType\x12\n\n\x06MOBILE\x10\x00\x12\x08\n\x04HOME\x10\x01\x12\x08\n\x04WORK\x10\x02\"%\n\x0c\x42uildingType\x12\x0b\n\x07private\x10\x00\x12\x08\n\x04\x66lat\x10\x01\"/\n\x0b\x41\x64\x64ressBook\x12 \n\x06people\x18\x01 \x03(\x0b\x32\x10.tutorial.Person')
)
...
_PERSON_BUILDINGTYPE = _descriptor.EnumDescriptor(
  name='BuildingType',
  full_name='tutorial.Person.BuildingType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_PERSON_BUILDINGTYPE)
...
_PERSON_ADDRESS = _descriptor.Descriptor(
  name='Address',
  full_name='tutorial.Person.Address',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='street', full_name='tutorial.Person.Address.street', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='number', full_name='tutorial.Person.Address.number', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='tutorial.Person.Address.type', index=2,
...
_PERSON = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='addresses', full_name='tutorial.Person.addresses', index=4,
  ...
  nested_types=[_PERSON_PHONENUMBER, _PERSON_ADDRESS, ],
  enum_types=[
    _PERSON_PHONETYPE,
    _PERSON_BUILDINGTYPE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_PERSON_ADDRESS.fields_by_name['type'].enum_type = _PERSON_BUILDINGTYPE
...
_PERSON_BUILDINGTYPE.containing_type = _PERSON
...
Person = _reflection.GeneratedProtocolMessageType('Person', (_message.Message,), dict(
  ...
  Address = _reflection.GeneratedProtocolMessageType('Address', (_message.Message,), dict(
    ...
    __module__ = 'addressbook_pb2'
    # @@protoc_insertion_point(class_scope:tutorial.Person.Address)
    ))
  ,
  DESCRIPTOR = _PERSON,
  __module__ = 'addressbook_pb2'
